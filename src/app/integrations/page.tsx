...
const TOOLS = [
  ...
  },
  {
    name: "join_meeting",
    description:
      "Send the Voisli bot to join a video meeting (Zoom, Google Meet, Teams, etc.).",
    inputs: [
      { name: "meeting_url", type: "string", required: true, desc: "Full meeting URL" },
      { name: "bot_name", type: "string", required: false, desc: "Display name for the bot (default: Voisli)" },
    ],
  },
  {
    name: "leave_meeting",
