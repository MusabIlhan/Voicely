...
TWILIO_PHONE_NUMBER=+1xxxxxxxxxx`}</pre>
            ...
            >
              ...
              <p className="mt-2 text-xs text-muted/60">
                Once connected, Claude can use <span className="text-accent">{MCP_TOOLS.length} tools</span>:{" "}
                <code className="text-accent">initiate_call</code> and{" "}
                <code className="text-accent">join_meeting</code>
              </p>
              <div className="mt-3">
